...
Hexahedron = _autoloading_shape('obj/hexahedron.obj', _hexahedron_symmetries)

_octohedron_symmetries = {
	4: [(0, 5), (1, 6), (2, 7), (3, 4)],
}
Octohedron = _autoloading_shape('obj/octohedron.obj', _octohedron_symmetries)

_dodecahedron_symmetries = {
	6: [(0, 4), (1, 5), (2, 11), (3, 7), (6, 10), (8, 9)],
	4: [(0, 1, 2), (3, 10, 11), (4, 7, 9), (5, 6, 8)],
}
Dodecahedron = _autoloading_shape('obj/dodecahedron.obj', _dodecahedron_symmetries)
